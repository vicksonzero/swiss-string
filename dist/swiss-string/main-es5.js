            ...
            keys.forEach(function (_a, keyIndex) {
                ...
                var line = (function () {
                    if (_destStepIndex - afterStepIndex <= 1) {
                        ...
                        var escapeX = sidebarX + Object(src_utils__WEBPACK_IMPORTED_MODULE_3__["hashStringToNumber"])(name) * sidebarWidth;
                        var curve1 = [
                            fromPoint.x + " " + (fromPoint.y + connectorMomentum),
...
var StepFactory = /** @class */ (function () {
    ...
    StepFactory.createStep = function (config) {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, a, config);
    };
    return StepFactory;
}());
                ...
                case _Step__WEBPACK_IMPORTED_MODULE_5__["WidgetType"].VIEW:
                    {
                        columns.forEach(function (column) {
                            ...
                            afterContext.keys.push({ name: name, destStepIndex: stepIndex, fromID: columnID, toID: null, type: null });
                ...
                case _Step__WEBPACK_IMPORTED_MODULE_5__["WidgetType"].OPERATOR:
                    {
                        columns.forEach(function (column) {
                            ...
                            Object.entries(inputs).forEach(function (_a) {
                                ...
                                var _f = contextHolder[contextName], lastSeenID = _f.lastSeenColumnID, lastSeenStepIndex = _f.lastSeenStepIndex;
                                try {
                                    for (var newContexts_2 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](newContexts), newContexts_2_1 = newContexts_2.next(); !newContexts_2_1.done; newContexts_2_1 = newContexts_2.next()) {
                                        ...
                                        try {
                                            for (var _g = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](context.keys), _h = _g.next(); !_h.done; _h = _g.next()) {
                                                var key = _h.value;
                                                if (key.fromID === lastSeenID) {
...
function hashStringToColor(str) {
    var hash = djb2(str);
    var _a = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](hslToRgb((hash + 2147483648) / 4294967295, 1, 0.5), 3), r = _a[0], g = _a[1], b = _a[2];
